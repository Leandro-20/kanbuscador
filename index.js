...
const buscador = (url, atributo, texto) => 
axios({
    url: `${url}`,
    data: `
  ...
  //buscador('https://visor.obraspublicas.gob.ar/gs/ows?service=WFS&outputFormat=json','Expediente', 27741).then(({ data }) => {console.log(data.features)})
